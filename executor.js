  ...
  try {
    ...
    switch (toolName) {
      ...
      case 'calendar_update_event': {
        ...
        result = { success: true, ...updResult, message: `Event updated: ${Object.keys(updates).join(', ')}` };
    ...
    case 'maintenance_update_status': {
      ...
      case 'doc_create_pdf': {
        ...
        result = { success: true, file_path: pdfPath, message: 'PDF created' };
        break;
      }
      ...
      case 'doc_create_docx': {
        ...
        result = { success: true, file_path: docxPath, message: 'DOCX created' };
        break;
      }
      ...
      case 'doc_create_xlsx': {
        ...
        result = { success: true, file_path: xlsxPath, message: 'XLSX created' };
        break;
      }
      ...
      case 'doc_create_pptx': {
        ...
        result = { success: true, file_path: pptxPath, message: 'PPTX created' };
        break;
      }
