// Deep audit of Staff Sheet - ALL tabs, ALL cells with formulas
...
async function audit() {
  ...
  console.log('=== STAFF SHEET - ALL TABS ===');
  ...
  for (const tab of tabNames) {
    ...
    const scanRows = Math.min(maxRow, 200);
    const scanCols = Math.min(maxCol, 26); // up to Z
